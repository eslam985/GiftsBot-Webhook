     ...
     reply_markup: {
      inline_keyboard: [
       ...
       [
        {
         "text": "📁 عرض الأقسام",
         "callback_data": "SHOW_CATEGORIES" // ⬅️ تغيير إلى أمر مخصص
        }
       ],
...
const getCategoryButtons = () => {
 return {
   ...
   payload: {
    telegram: {
     ...
     reply_markup: {
      inline_keyboard: [
       [
        { "callback_data": "وريني كل منتجات مجوهرات", "text": "مجوهرات" },
        { "callback_data": "وريني كل منتجات إلكترونيات", "text": "إلكترونيات" }
       ],
       [
        { "callback_data": "وريني كل منتجات هدايا رجالية", "text": "هدايا رجالية" },
        { "text": "Home Goods", "callback_data": "وريني كل منتجات Home Goods" }
       ]
      ]
     }
    }
  ...
  fulfillmentText: "رسالة احتياطية للفئات"
 };
};
