 ...
 */
// **ملاحظة هامة:** يجب تعريف `products` و `categoryMap` في أعلى ملف logic.js
// كمثال:
// const products = [{ name: 'محفظة جلد رجالية', category: 'هدايا رجالية', price: 180 }, ...];
// const categoryMap = { 'هدايا رجالية': 'هدايا رجالية', 'مجوهرات': 'مجوهرات' };
...
const getCategory = (categoryName) => {
 ...
 if (filteredProducts.length > 0) {
  ...
  // ب. إرجاع Custom Payload متوافق مع Dialogflow وتليجرام
  return {
   fulfillmentText: `🛒 المنتجات المتاحة في فئة "${categoryName}"، اختر المنتج الذي تريده:`,
   fulfillmentMessages: [{
    "platform": "telegram",
    "payload": {
     "telegram": {
